...
namespace EiAtende.Web.Helpers
{
    public class clsEnviarEmail
    {
        public string EnviarEmail(string smtpDominio, string smtpUsuario, string smtpSenha, string smtpPorta, string EmailTo, string EmailAssunto, string EmailBody, string PatchAnexo, string ComCopia)
        {
            try
            {
