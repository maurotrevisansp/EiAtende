 ...
 * **alwaysShow**: if true the threshold will be ignored and the remaining length indication will be always Mostrando up while typing or on focus on the input. Default: false.
