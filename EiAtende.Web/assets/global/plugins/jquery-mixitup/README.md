...
These two styles ensure that there's no FOUC (flash of unstyled content) or Mostrando of hidden target elements before MixItUp instantiates. This way, MixItUp controls the initial loading of your elements, when your page is ready.
